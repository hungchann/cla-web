        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {simplifiedCourses.map((course) => (
            <button
              ...
              className="group bg-white rounded-xl overflow-hidden border border-zinc-100 shadow-xs hover:shadow-md hover:border-amber-200 transition-all duration-300 flex flex-col text-left cursor-pointer w-full"
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <h3 className="font-bold text-zinc-900 group-hover:text-amber-600 transition-colors duration-200 text-[15px] leading-snug">
                  {course.title}
                </h3>
                <div className="text-xs text-zinc-500 font-medium flex items-center gap-1.5 pt-2 border-t border-zinc-50">
