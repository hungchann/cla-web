                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`pb-2 transition-all cursor-pointer bg-transparent border-none ${isActive ? "border-b-2 border-zinc-900 dark:border-zinc-50 text-zinc-900 dark:text-zinc-50" : "hover:text-zinc-600 dark:hover:text-zinc-350"
                                    }`}
                            >
                                {tab.name}
                            </button>
