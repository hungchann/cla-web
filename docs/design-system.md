# Sunchinese Web Design System

This document serves as the **Single Source of Truth** for the design language, styling, spacing, and layout of the Sunchinese Web application. All new components and pages MUST adhere to these rules.
